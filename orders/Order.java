...
public class Order implements OrderProcessing
{
    ...
    throws OrderException
    {
        ...
        sound.playSound("doorbell"); // Plays sound effect when order is added
    }
    ...
    throws OrderException
    {
        ...
        for ( int i=0; i < folders.size(); i++)
        {
            ...
            folders.get(i).getState()                == State.BeingPicked )
            {
                ...
                sound.playSound("buzzer"); // Plays sound effect when order is picked 
                return true;
            }
        }
        return false;
    ...
    throws OrderException
    {
        ...
        for ( int i=0; i < folders.size(); i++)
        {
            ...
            {
                folders.remove(i);
                sound.playSound("exitcue"); // Plays sound effect when order is collected
                return true;
            }
        }
        return false;
