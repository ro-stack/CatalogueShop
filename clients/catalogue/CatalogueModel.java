...
/**
 * Implements the Model of the catalogue client
...
public class CatalogueModel extends Observable
{
  ...
  public void doCheck(String productNum )
  {
    ...
    {
      DEBUG.error("CatalogueClient.doCheck()\n%s",
      e.getMessage() );
    }
  ...
  public void doClear()
  {
    String theAction = "";
    theBasket.clear();                        // Clear s. list
    theAction = "Enter Product Name";         // Set display
  ...
  {
    setChanged(); notifyObservers("Enter Product N"); // Notify
  }
