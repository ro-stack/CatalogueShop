...
public class BackDoorView implements Observer
{
    ...
    public BackDoorView(  RootPaneContainer rpc, MiddleFactory mf, int x, int y )
    {
        ...
        //COLOURS
        theAction.setBackground(new Color(151,192,231));
        theInput.setBackground(new Color(151,192,231));
        theInputNo.setBackground(new Color(151,192,231));
        theOutput.setBackground(new Color(151,192,231));
        theSP.setBackground(new Color(151,192,231));
        theBtClear.setBackground(new Color(151,192,231));
        theBtRStock.setBackground(new Color(151,192,231));
        theBtQuery.setBackground(new Color(151,192,231));

        cp.setBackground(new Color(179,30,60)); 
        
        // FONT COLOURS
        theAction.setForeground(new Color(179,30,60));
        theInput.setForeground(new Color(179,30,60));
        theOutput.setForeground(new Color(179,30,60));
        theSP.setForeground(new Color(179,30,60));
        theBtClear.setForeground(new Color(179,30,60));
        theInputNo.setForeground(new Color(179,30,60));
        theBtRStock.setForeground(new Color(179,30,60));
        theBtQuery.setForeground(new Color(179,30,60));
    }
